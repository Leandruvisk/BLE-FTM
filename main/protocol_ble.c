...
const uint8_t  spp_command_val[10] = {0x00};
...
const uint16_t spp_heart_beat_uuid = ESP_GATT_UUID_SPP_HEARTBEAT;
const uint8_t  spp_heart_beat_val[2] = {0x00, 0x00};
const uint8_t  spp_heart_beat_ccc[2] = {0x00, 0x00};
#endif
